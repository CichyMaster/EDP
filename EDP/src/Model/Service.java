...
public class Service {
    ...
    public static synchronized Service getInstance()
    {
        ...
        public List<Phones> selectPhones(){
            List<Phones> phones = new LinkedList<Phones>();
            try{
    ...
    public synchronized List<Repairs> selectRepairs(){
        ...
        try{
            ResultSet result = stat.executeQuery("SELECT nr_case, imei, model, acronym, operator, status, admission_date, end_date FROM \"Repairs\", \"Phones\", \"Workers\" \n" +
    ...
    public Integer idOfAcronym(String acronym){
        ...
        public synchronized boolean insertRepair(int idPhone, int idWorker, String nrCase, long imei, String admissionDate, String operator, String status ){
        try {
